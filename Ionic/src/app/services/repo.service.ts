...
export class RepoService {
  ...
  //Update
  updateQualification(qualificationId: number, qualification: QualificationType): Observable<any>{
    return this.http.put(`${this.base+this.QualificationController}update?id=${qualification}`,qualification, this.httpOptions);
  }
  //Delete
